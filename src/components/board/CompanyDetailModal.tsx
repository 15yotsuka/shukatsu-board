    ...
    <div className="fixed inset-0 z-[60] flex items-end md:items-center justify-center">
      ...
      <div className="relative bg-white rounded-t-2xl md:rounded-2xl w-full max-w-lg max-h-[85vh] overflow-y-auto animate-slide-up">
        ...
        <div className="p-4 space-y-4">
          ...
          {/* マイページ情報 */}
          <div>
            <h3 className="text-[13px] font-semibold text-[#8E8E93] uppercase tracking-wide mb-2 px-1">
              マイページ情報
            </h3>
            <div className="bg-[#F2F2F7] rounded-xl overflow-hidden">
              <div className="bg-white divide-y divide-[#E5E5EA]">
                <div className="px-4 py-3">
                  ...
                  {myPageUrl.trim() && (
                    <a
                      ...
                      className="inline-flex items-center gap-1 mt-2 text-[14px] text-[#007AFF] font-medium ios-tap"
                    >
                ...
                <div className="px-4 py-3">
                  ...
                  <div className="flex items-center gap-2">
                    ...
                    <button
                      ...
                      className="w-11 h-11 flex items-center justify-center text-[#8E8E93] ios-tap shrink-0"
